...
public class AccountController : Controller
{
    ...
    public async Task<IActionResult> Register(RegisterViewModel model)
        ...
        {
            var user = new AppUser { UserName = model.Email, Email = model.Email, Name = model.Name, Adress = model.Adress, PhoneNumber = model.PhoneNumber, InvoiceAdress = model.InvoiceAdress, EmailConfirmed = true };
